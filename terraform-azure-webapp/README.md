...
| <a name="input_application_stack"></a> [application\_stack](#input\_application\_stack) | Objeto para definir o tipo de linguagem do webapp, definir languague e version dentro de um objeto | <pre>object({<br/>    language = string<br/>    version  = string<br/>  })</pre> | <pre>{<br/>  "language": "node",<br/>  "version": "20-lts"<br/>}</pre> | no |
...
| <a name="input_logs_retention_in_days"></a> [logs_retention_in_days](#input\_logs_retention_in_days) | Retenção de logs em dias | `number` | 7 | no |
