...
resource "azurerm_linux_web_app" "app_webapp" {
  ...
  site_config {
    application_stack {
      dotnet_version = var.application_stack.language == "dotnet" ? var.application_stack.version : null
      java_version   = var.application_stack.language == "java" ? var.application_stack.version : null
      node_version   = var.application_stack.language == "node" ? var.application_stack.version : null
      php_version    = var.application_stack.language == "php" ? var.application_stack.version : null
      python_version = var.application_stack.language == "python" ? var.application_stack.version : null
      ruby_version   = var.application_stack.language == "ruby" ? var.application_stack.version : null
    }
